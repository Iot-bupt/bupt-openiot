					...
					<tbody>
						<#list pageInfo.list as device>
							<tr>
								...
								<td><a href='${request.contextPath}/api/noauth/profile?deviceId=${device.id}'>编辑</a></td>
								<td><a href='${request.contextPath}/api/noauth/device/delete?deviceId=${device.id}' class='btn btn-danger'>删除</a>
									<a href='${request.contextPath}/api/noauth/devicemanage/control?deviceId=${device.id}' class='btn btn-success'>控制</a></td>
							</tr>
						</#list>
					</tbody>
