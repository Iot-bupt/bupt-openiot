...
import com.bupt.openiot.service.security.auth.jwt.RefreshTokenRepository;
...
public class RestAwareAuthenticationSuccessHandler implements AuthenticationSuccessHandler {
    ...
    public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response,
        ...
        tokenMap.put("token", (String) request.getSession().getAttribute("token"));
       // tokenMap.put("refreshToken", refreshToken.getToken());
        tokenMap.put("refreshToken", (String) request.getSession().getAttribute("refreshToken"));
